...
public abstract class ArbolBinario<T> implements Coleccion<T> , Serializable{
    ...
    protected class Vertice implements VerticeArbolBinario<T> , Serializable{
        ...
        public int altura() {
            ...
            return 1 + Math.max(izquierdo != null ? izquierdo.altura() : 0, derecho != null ? derecho.altura() : 0);
        }
        ...
        public boolean equals(Object objeto) {
            ...
            if (vertice.elemento.equals(elemento)) {
                try {
                    return (izquierdo == null && vertice.izquierdo == null
                            || vertice.izquierdo.equals(izquierdo)) && (derecho == null && vertice.derecho == null
                            || vertice.derecho.equals(derecho));
